                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="tipo_doc" type="text" class="form-control @error('tipo_doc') is-invalid @enderror" name="tipo_doc" required autocomplete="tipo_doc">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="regional" class="form-control @error('regional') is-invalid @enderror" name="regional">
                                    <option selected>Selecciona una regional</option>
                        ...
                        <div class="row mb-3">
                            <label for="centro_form" class="col-md-4 col-form-label text-md-end">{{ __('centro_form') }}</label>
