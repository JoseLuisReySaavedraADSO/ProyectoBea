                ...
                <form class="register__form" action="{{ route('userAction', ['action' => 'create']) }}" method="get">
                    ...
                    <div>
                        <div class="form__item">
                            ...
                            <div>
                                <input placeholder="@error('nombre') {{ $message }} @enderror" id="nombre"
                                    type="text" class="@error('nombre') is-invalid @enderror item__input" name="nombre"
                        ...
                        <div class="form__item">
                            ...
                            <div>
                                <input placeholder="@error('telefono') {{ $message }} @enderror" id="telefono"
                                    type="text" class="@error('telefono') is-invalid @enderror item__input"
                    ...
                    <div>
                        <div class="form__item">
                            ...
                            <div>
                                <select id="tipo_doc" class="@error('tipo_doc') is-invalid @enderror item__input"
                                    name="tipo_doc"
                                    @if (!$errors->has('tipo_doc')) value=" {{ old('tipo_doc') }}" @endif>
                        ...
                        <div class="form__item">
                            ...
                            <div>
                                <input placeholder="@error('num_doc') {{ $message }} @enderror" id="num_doc"
                                    type="text" class="@error('num_doc') is-invalid @enderror item__input"
                                    name="num_doc" required autocomplete="num_doc"
                    ...
                    <div>
                        <div class="form__item">
                            ...
                            <div>
                                <input placeholder="@error('email') {{ $message }} @enderror" id="email"
                                    type="email" class="@error('email') is-invalid @enderror item__input"
                        ...
                        <div class="form__item">
                            ...
                            <div>
                                <input placeholder="@error('correo_alt') {{ $message }} @enderror" id="correo_alt"
                    ...
                    <div>
                        <div class="form__item">
                            ...
                            <div>
                                <select id="regional" class="@error('regional') is-invalid @enderror item__input"
                                    name="regional"
                                    @if (!$errors->has('regional')) value=" {{ old('regional') }}" @endif>
                        ...
                        <div class="form__item">
                            ...
                            <div>
                                <input placeholder="@error('centro_form') {{ $message }} @enderror" id="centro_form"
